...
function LanguageProvider({ children }) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "LanguageProvider.useEffect": ()=>{
            ...
            ;
            const stored = window.localStorage.getItem("kbi-lang");
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "LanguageProvider.useEffect": ()=>{
            ...
            let triggered = false;
            const reload = {
                "LanguageProvider.useEffect.reload": ()=>{
                    if (triggered) return;
                    triggered = true;
                    try {
                        ...
                        if (c && c.keys) {
                            c.keys().then({
                                "LanguageProvider.useEffect.reload": (keys)=>{
                                    for (const k of keys)c.delete(k).catch({
                                        "LanguageProvider.useEffect.reload": ()=>{}
                                    }["LanguageProvider.useEffect.reload"]);
                                }
                            }["LanguageProvider.useEffect.reload"]).catch({
                                "LanguageProvider.useEffect.reload": ()=>{}
                            }["LanguageProvider.useEffect.reload"]);
                        }
                    } catch  {
            ...
            const onError = {
                "LanguageProvider.useEffect.onError": (e)=>{
                    const t = e.target;
            ...
            }["LanguageProvider.useEffect.onError"];
            const onRejection = {
                "LanguageProvider.useEffect.onRejection": (e)=>{
            ...
            }["LanguageProvider.useEffect.onRejection"];
...
_s(LanguageProvider, "Q6Y7/1dgCKWEx+ycXuGHIruIUCk=");
_c = LanguageProvider;
...
function useT() {
    ...
    return (key)=>lang === "ar" ? DICTIONARY[key] || key : key;
}
_s2(useT, "GXyK8e6a44mVG57X3BP71uFgqGc=", false, function() {
    return [
        useLanguage
    ];
});
...
//# sourceMappingURL=components_652862bb._.js.map